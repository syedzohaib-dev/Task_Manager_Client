...
const Completed = () => {
  ...
  return (
    <>
      <div className="w-full h-screen overflow-y-auto bg-gray-100 border flex gap-4 my-5 justify-center flex-wrap pb-3">


        {/* <div className="flex flex-wrap gap-4"> */}
          {tasks
            .filter(task => task.status === "completed")   // <-- FILTER HERE
            .map((task, index) => (
              <TaskCard
                key={index}
                task={task}
